...
int main()
{
    ...
    while (true)
    {
        for (int i = 0; i < 1; i++) 
        {
            dense_0_1.inference(layer_1, layer_0_1);
            bias_1.inference(layer_0_1);
            activ_1.inference(layer_0_1);
            layer_1 += (layer_0_1 * 0.1);
        }
        ...
        dense_0_1.backpropagation(layer_1, layer_1);
        //--------------------------------------------------
