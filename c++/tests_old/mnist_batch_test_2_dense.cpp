...
int main()
{
    ...
    nn::layers::dropoutlayer dropout_0
    (
        {28,28,1,1},
        "Dropout 0",
        0.1
    ...
    nn::layers::nodelayer layer_6_inference
    (
        {10,1,1,1,1}, 
        "Layer 5", 
        true
    ...
    nn::layers::dropoutlayer dropout_6
    (
        {10,1,1,1},
        "Dropout 5",
        0.1
    ...
    // 6 : Classification
    //--------------------------------------------------
    nn::layers::softmaxlayer softmax_6;
    //--------------------------------------------------
    ...
    dropout_0.set_dropout(0.0);
    dropout_1.set_dropout(0.0);
    dropout_2.set_dropout(0.0);
    dropout_4.set_dropout(0.0);
    dropout_5.set_dropout(0.0);
    dropout_6.set_dropout(0.9);
    ...
    for (int e = 0; e < epochs; e++)
    {
        ...
        for (int i = 0; i < iterations; i++)
        {
            ...
            //==================================================
                ...
                //norm_5.stat_analysis(layer_5);
                //norm_5.inference(layer_5);
                ...
                dropout_6.inference(layer_6);
                //--------------------------------------------------

                // 6 : Classification
                //--------------------------------------------------
                softmax_6.inference(layer_6, layer_6);
                //--------------------------------------------------
            ...
            //==================================================
                ...
                // 5 : Feature Projection
                //--------------------------------------------------
                dropout_6.backpropagation(layer_6);
                ...
                //norm_5.backpropagation(layer_5);
                ...
                // 0 : Input
                //--------------------------------------------------
                //dropout_0.backpropagation(layer_0);
            ...
            //==================================================
                ...
                //activ_5.print();
                //activ_5.print_jacobian();
                //norm_5.print();
                //norm_5.print_jacobian();
                //dropout_5.print();
                //layer_5.print();
                //layer_5.print_delta();
                //--------------------------------------------------
                ...
                //--------------------------------------------------
                //dense_5_6.print();
                //dense_5_6.print_jacobian();
                //bias_6.print();
                //bias_6.print_jacobian();
                //dropout_6.print();
                //layer_6.print();
                //layer_6.print_delta();
                //--------------------------------------------------
            ...
            //==================================================
                ...
                activ_5.gradient_decent_adam(batch_size, step_size, beta1, beta2, epsilon);
                //norm_5.gradient_decent_adam(batch_size, step_size, beta1, beta2, epsilon);
                //--------------------------------------------------
        ...
        */
        ...
        //==================================================
            ...
            activ_5.inference(layer_5_inference);
            //norm_5.inference(layer_5_inference);
            //--------------------------------------------------

            // 6 : Feature Projection
            //--------------------------------------------------
            dense_5_6.inference(layer_5_inference, layer_6_inference);
            bias_6.inference(layer_6_inference);
            //--------------------------------------------------

            // 6 : Classification
            //--------------------------------------------------
            softmax_6.inference(layer_6_inference, layer_6_inference);
            //--------------------------------------------------
        ...
        //==================================================
            ...
            float max_node = 0;
            int max_index = 0;
            for (int j = 0; j < layer_6_inference.get_size(); j++)
            {
                float node = layer_6_inference[j];
                if (node > max_node)
                {
                    max_node = node;
                    max_index = j;
