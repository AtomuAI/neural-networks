...
int main()
{
    ...
    nn::layers::ltcctrnnlayer ltc_0_1
    (
        {1,1,1,360,1}, 
        {100,1,1,360,1},
        "Ltc_0_1", 
    ...
    nn::layers::ltcctrnnlayer ltc_1_2
    (
        {100,1,1,360,1}, 
        {100,1,1,360,1},
        "Ltc_1_2", 
    ...
    nn::layers::ltcctrnnlayer ltc_2_3
    (
        {100,1,1,360,1}, 
        {100,1,1,360,1},
        "Ltc_2_3", 
    ...
    nn::layers::ltcctrnnlayer ltc_3_4
    (
        {100,1,1,360,1}, 
        {100,1,1,360,1},
        "Ltc_3_4", 
    ...
    nn::layers::ltcctrnnlayer ltc_4_5
    (
        {100,1,1,360,1}, 
        {100,1,1,360,1},
        "Ltc_4_5", 
    ...
    nn::layers::ltcctrnnlayer ltc_5_6
    (
        {100,1,1,360,1}, 
        {2,1,1,360,1},
        "Ltc_5_6", 
    ...
    ltc_0_1.initialize(nn::core::initialization::he, util::core::distribution::normal);
    ltc_1_2.initialize(nn::core::initialization::he, util::core::distribution::normal);
    ltc_2_3.initialize(nn::core::initialization::he, util::core::distribution::normal);
    ltc_3_4.initialize(nn::core::initialization::he, util::core::distribution::normal);
    ltc_4_5.initialize(nn::core::initialization::he, util::core::distribution::normal);
    ltc_5_6.initialize(nn::core::initialization::he, util::core::distribution::normal);
    ...
    */
    ...
    {
        layer_0[i] = i;
        target_6[i*2] = r * cos(util::ops::degrees_to_radians((float)i));
    ...
    while (true)
    {
        ...
        //ltc_5_6.backpropagation(layer_5, layer_6);
        activ_5.backpropagation(layer_5);
        bias_5.backpropagation(layer_5);
        dense_4_5.backpropagation(layer_4, layer_5);
        //ltc_4_5.backpropagation(layer_4, layer_5);
        activ_4.backpropagation(layer_4);
        bias_4.backpropagation(layer_4);
        dense_3_4.backpropagation(layer_3, layer_4);
        //ltc_3_4.backpropagation(layer_3, layer_4);
        activ_3.backpropagation(layer_3);
        bias_3.backpropagation(layer_3);
        dense_2_3.backpropagation(layer_2, layer_3);
        //ltc_2_3.backpropagation(layer_2, layer_3);
        activ_2.backpropagation(layer_2);
        bias_2.backpropagation(layer_2);
        dense_1_2.backpropagation(layer_1, layer_2);
        //ltc_1_2.backpropagation(layer_1, layer_2);
        activ_1.backpropagation(layer_1);
        bias_1.backpropagation(layer_1);
        dense_0_1.backpropagation(layer_0, layer_1);
        //ltc_0_1.backpropagation(layer_0, layer_1);
        
        /*
        ltc_0_1.gradient_decent_adam(batch_size, step_size, beta1, beta2, epsilon);
        ltc_1_2.gradient_decent_adam(batch_size, step_size, beta1, beta2, epsilon);
        ltc_2_3.gradient_decent_adam(batch_size, step_size, beta1, beta2, epsilon);
        ltc_3_4.gradient_decent_adam(batch_size, step_size, beta1, beta2, epsilon);
        ltc_4_5.gradient_decent_adam(batch_size, step_size, beta1, beta2, epsilon);
        ltc_5_6.gradient_decent_adam(batch_size, step_size, beta1, beta2, epsilon);
        */
